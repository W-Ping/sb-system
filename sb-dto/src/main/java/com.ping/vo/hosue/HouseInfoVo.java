...
public class HouseInfoVo extends BaseVo {
     ...
     *
     */
    private List<HouseDetailInfoVo> detailInfoVos;
    ...
    public List<HouseDetailInfoVo> getDetailInfoVos() {
        return detailInfoVos;
    }

    public void setDetailInfoVos(List<HouseDetailInfoVo> detailInfoVos) {
